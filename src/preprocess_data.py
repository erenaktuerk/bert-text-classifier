...
def save_processed_data(df, output_path):
    """
    Saves the processed dataset to a CSV file with only 'review' and 'label' columns.
    ...
    try:
        ...
        if 'review' not in df.columns or 'label' not in df.columns:
            raise ValueError("The processed dataset does not contain the required columns 'review' and 'label'.")
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("Data preprocessing completed. Processed data saved to:", output_file)
    except Exception as e:
