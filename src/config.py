...
# Data processing
REDUCTION_PERCENTAGE = 0.02  # Reduction percentage for the dataset (e.g., 0.1 means 0.1% of the original data)

# Data augmentation
USE_AUGMENTATION = False     # Set to True to apply augmentation to the training data
